...
contradiction [ADR-0023](00023-day-one-gates.md) Am. 3's own auth gate
...
environments — **test accounts** (the `test@fluxvale.com` seed, [ADR-0023](00023-day-one-gates.md))
